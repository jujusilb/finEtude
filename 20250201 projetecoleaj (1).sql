...
(1, 'Français'),(2, 'Mathématique'),(3, 'SVT'),
(4, 'Histoire'),(5, 'Géographie'),(6, 'Anglais'),
(7, 'Espagnol'),(8, 'Allemand'),(9, 'Physique'),
(10, 'Chimie'),(11, 'Technologie'),(12, 'Bureautique'),
(13, 'Informatique'),(14, 'EPS'),(15, 'Anatomie'),
(16, 'Neurologie'),(17, 'Pharmacologie'),(18, 'Pratique de massage'),
(19, 'Pratique de massage'),(20, 'Musique'),(21, 'CRCD'),(22, 'TRE');
...
INSERT INTO `membre` (`id`, `nom`, `prenom`, `image_name`, `updated_at`, `created_at`, `discrimination`) VALUES
	...
	(32, 'DOUCOURE', 'ADJA', 'frame-3-67954547ecef0011385340-679cc3db6344d713279830.gif', '2025-01-31 13:36:43', '2025-01-31 13:36:43', 'eleve'),
...
INSERT INTO `personnel` (`id`, `date_embauche`, `poste`) VALUES
	...
	(29, '2020-01-01', '0146780100'),(34, '2020-01-01', '0146780100');
...
INSERT INTO `promotion` (`id`, `referent_id`, `libelle`) VALUES
	...
	(4, 4, 'PREPA CRCD'),(5, 7, 'CRCD'),(6, 8, 'PMK'),
	(7, 3, 'K1'),(8, 10, 'K2'),(9, 11, 'K3'),
	(10, 12, 'K4'),(11, 5, 'K5');
...
INSERT INTO `eleve` (`id`, `promotion_id`, `email`, `password`, `roles`, `login`) VALUES
	(12, 2, 'Jsilberstein@guinot.asso.fr', 'mdp', '[\"ROLE_ELEVE\"]', 'jsilberstein'),
	(13, 2, 'adreche@guinot.asso.fr', 'mdp', '[\"ROLE_ELEVE\"]', 'adreche'),
	(14, 2, 'belamrani', 'mdp', '[\"ROLE_ELEVE\"]', 'belamrani'),
	(15, 1, 'amarie@guinot.asso.fr', 'mdp', '[\"ROLE_ELEVE\"]', 'amarie'),
	(16, 2, 'mlnoel@guinot.asso.fr', 'mdp', '[\"ROLE_ELEVE\"]', 'mlnoel'),
	(17, 2, 'cerrajouani', 'mdp', '[\"ROLE_ELEVE\"]', 'cerrajouani'),
	(18, 1, 'mmazeau@guinot.asso.fr', 'mdp', '[\"ROLE_ELEVE\"]', 'mmazeau'),
	(19, 1, 'pdugbe', 'mdp', '[\"ROLE_\"]', 'pdugbe'),
	(32, 5, 'adoucoure@guinot.asso.fr', 'mdp', '[\"ROLE_ELEVE\"]', 'adoucoure');
...
INSERT INTO `programme` (`professeur_id`, `matiere_id`, `promotion_id`) VALUES
	(1, 6, 1),(1, 6, 2),(2, 13, 2),(3, 13, 1),
	(4, 2, 3),(1, 6, 3),(1, 6, 4),
	(1, 6, 5),(1, 6, 6),(1, 6, 7),
	(1, 6, 8),(1, 6, 9),(1, 6, 10),
	(1, 6, 11),(7, 21, 5),(34, 1, 4),
	(4, 2, 4);
