...
use App\Repository\Boutique\EventRepository;
...
class Event
{
     ...
     */
    #[ORM\OneToMany(targetEntity: membreEvent::class, mappedBy: 'event')]
    ...
    public function removeMembreEvent(membreEvent $membreEvent): static
    {
        if ($this->membreEvents->removeElement($membreEvent)) {
            ...
            if ($membreEvent->getEvent() === $this) {
                $membreEvent->setEvent(null);
            }
        }
