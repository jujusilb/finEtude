...
use App\Entity\Documentaliste\CategorieOuvrage;
use App\Repository\Documentaliste\CategorieOuvrageRepository;
use App\Form\Documentaliste\CategorieOuvrageType;
...
class CategorieOuvrageController extends AbstractController
{
    ...
    public function index(CategorieOuvrageRepository $categorieOuvrageRepo): Response
    {
        ...
        return $this->render('documentaliste/Categorie_ouvrage/index.html.twig', [
